...
[![Run on Repl.it](https://repl.it/badge/github/dieenx/warp)](https://replit.com/@dieenx/warp)
...
5. Clone the git  `git clone https://github.com/dieenx/warp-plus-cloudflare.git`
